...
These 19 tools are the ones built into this client: powershell,
...
text_embeddings. Any other tool in your list comes from a connected MCP server and runs
on that server — those are real; use them. But if you are about to name a tool that is
in neither group, you are mistaken.
